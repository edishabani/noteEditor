## Welcome to NoteEditor 👋🏻

NoteEditor is a simple **note-taking app** that uses **Markdown** syntax to format your notes.
...
Here are all the heading formats currently supported by **_NoteEditor_**:
